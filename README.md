...
This is a simple File Uploader project built using Express, Prisma, with Server Side Rendering done with EJS.
...
git clone git@github.com:goran1010/file-uploader.git
